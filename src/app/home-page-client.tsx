          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div className="space-y-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                ...
                <div className="text-sm text-muted-foreground">One-time. Instant access after checkout.</div>
              </div>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card className="border-muted bg-muted/10">
              ...
              <CardContent className="space-y-3 text-sm text-muted-foreground">
                <p>- “Replace ‘responsible for’ with outcome-driven bullets and numbers.”</p>
                <p>- “Mirror key job keywords in skills and recent experience.”</p>
                <p>- “Your summary is generic; target one role and add 2–3 core competencies.”</p>
                <Separator />
                <p className="text-foreground">You’ll leave with a concrete plan—what to change, where, and why.</p>
              </CardContent>
            </Card>
          </div>
        </section>
